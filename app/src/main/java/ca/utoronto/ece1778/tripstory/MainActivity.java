...
public class MainActivity extends AppCompatActivity {
    ...
    public String[][] newstoryarray = new String[][]{
            {"frame1", "Who do you want to pick as a friend?", "f1_o1", "f1_o2", "f1_o3", "f1_o4", "You pick", "as a friend"},
...
//            Bundle b=new Bundle();
//            b.putIntArray("myStoryint", intarray);
//            Intent i=new Intent(MainActivity.this, Compile.class);
//            i.putExtras(b);
//            startActivity(i);
